...
pub struct RoomSettings {
    ...
    pub units: Option<FilterRules<usize>>,

    pub fog: bool,
    pub reinforcements: bool,

    pub max_units: usize,
    pub gold_amount: usize,
}
...
impl RoomInstance {
    pub fn new(units: &Vec<Unit>) -> Self {
        ...
        armies.push(gen_army(0, 0, units));
        armies.push(gen_army(1, 0, units));
...
fn gen_army(army_num: usize, gold: usize, units: &Vec<Unit>) -> Army {
